    ...
    case WaveType_Nwwav: {
        ...
        for (int i{0}; i < channelCount; ++i) {
            if (i < 2) {
                ...
                const WaveFile::ChannelInfo& lastChannelInfo{
                    m_pInfoBlockBody->GetChannelInfo(channelCount - 1)};
...
const void*
WaveFileReader::GetWaveDataAddress(const WaveFile::ChannelInfo* info,
