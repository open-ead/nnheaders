...
bool StreamSoundFileReader::IsOriginalLoopAvailableImpl(
    const StreamSoundFile::FileHeader* pHeader) {
...
bool StreamSoundFileReader::ReadDspAdpcmChannelInfo(DspAdpcmParam* pParam,
