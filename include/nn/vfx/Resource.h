...
class Resource {
public:
    Resource(gfx::TDevice<gfx::ApiVariationNvn8>*, Heap*, void*,
             gfx::TMemoryPool<gfx::ApiVariationNvn8>*, ulong, ulong, int, System*, bool, Resource*);
    virtual ~Resource();
    ...
    void RegisterTextureViewToDescriptorPool(
        bool (*)(gfx::DescriptorSlot*, const gfx::TTextureView<gfx::ApiVariationNvn8>&, void*),
        void*);
    void GetTextureDescriptorSlot(gfx::DescriptorSlot*, ulong) const;
    void SearchRecordFromResNameTable(detail::ResNameTableRecord*, ulong);
    void BindExternalResTextureFile(gfx::ResTextureFile*);
    void UnregisterTextureViewFromDescriptorPool(
        void (*)(gfx::DescriptorSlot*, const gfx::TTextureView<gfx::ApiVariationNvn8>&, void*),
        void*);
